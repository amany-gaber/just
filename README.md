-toon$ ^[[200~sudo apt update
^[[201~sudo: command not found
(newnev) yaz@gpu:~/Voice-toon$ sudo apt install ffmpeg -y
[sudo] password for yaz: 
Sorry, try again.
[sudo] password for yaz: 
Sorry, try again.
[sudo] password for yaz: 
sudo: 2 incorrect password attempts
(newnev) yaz@gpu:~/Voice-toon$ ^[[200~sudo apt update
^[[201~sudo: command not found
(newnev) yaz@gpu:~/Voice-toon$ sudo apt update
[sudo] password for yaz: 
...
WARNING:  StatReload detected changes in 'services/main.py'. Reloading...
INFO:     Started server process [2848976]
INFO:     Waiting for application startup.
INFO:     Application startup complete.
INFO:     127.0.0.1:45458 - "GET /docs HTTP/1.1" 200 OK
INFO:     127.0.0.1:45458 - "GET /openapi.json HTTP/1.1" 200 OK
INFO:     127.0.0.1:57806 - "POST /voice/inference HTTP/1.1" 400 Bad Request
INFO:     127.0.0.1:53020 - "POST /voice/inference HTTP/1.1" 400 Bad Request
INFO:     127.0.0.1:53020 - "POST /voice/inference HTTP/1.1" 400 Bad Request
WARNING:  StatReload detected changes in 'routes/user.py'. Reloading...
INFO:     Shutting down
INFO:     Waiting for application shutdown.
INFO:     Application shutdown complete.
INFO:     Finished server process [2848976]
...
Traceback (most recent call last):
  ...
  File "/home/yaz/Voice-toon/newnev/lib/python3.12/site-packages/uvicorn/config.py", line 435, in load
    self.loaded_app = import_from_string(self.app)
                      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/yaz/Voice-toon/newnev/lib/python3.12/site-packages/uvicorn/importer.py", line 22, in import_from_string
    raise exc from None
  File "/home/yaz/Voice-toon/newnev/lib/python3.12/site-packages/uvicorn/importer.py", line 19, in import_from_string
    module = importlib.import_module(module_str)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  File "/home/yaz/Voice-toon/api/src/routes/__init__.py", line 1, in <module>
    from .user import router
  File "/home/yaz/Voice-toon/api/src/routes/user.py", line 2, in <module>
    from services.audio import EmotionInference  # تأكدي إن المسار صحيح
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ModuleNotFoundError: No module named 'services.audio'
^CINFO:     Stopping reloader process [2835491]
(newnev) yaz@gpu:~/Voice-toon/api/src$ pip install services.audio
ERROR: Could not find a version that satisfies the requirement services.audio (from versions: none)
ERROR: No matching distribution found for services.audio
(newnev) yaz@gpu:~/Voice-toon/api/src$ uvicorn main:app --reload --port 8000
INFO:     Will watch for changes in these directories: ['/home/yaz/Voice-toon/api/src']
INFO:     Uvicorn running on http://127.0.0.1:8000 (Press CTRL+C to quit)
INFO:     Started reloader process [2864242] using StatReload
Process SpawnProcess-1:
Traceback (most recent call last):
  File "/opt/anaconda3/lib/python3.12/multiprocessing/process.py", line 314, in _bootstrap
    self.run()
  ...
  File "/home/yaz/Voice-toon/api/src/routes/user.py", line 2, in <module>
    ...
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ModuleNotFoundError: No module named 'services.audio'
^CINFO:     Stopping reloader process [2864242]
(newnev) yaz@gpu:~/Voice-toon/api/src$ pip install services.audio
ERROR: Could not find a version that satisfies the requirement services.audio (from versions: none)
ERROR: No matching distribution found for services.audio
(newnev) yaz@gpu:~/Voice-toon/api/src$ uvicorn main:app --reload --port 8000 --app-dir .
INFO:     Will watch for changes in these directories: ['/home/yaz/Voice-toon/api/src']
INFO:     Uvicorn running on http://127.0.0.1:8000 (Press CTRL+C to quit)
INFO:     Started reloader process [2865422] using StatReload
Process SpawnProcess-1:
Traceback (most recent call last):
  File "/opt/anaconda3/lib/python3.12/multiprocessing/process.py", line 314, in _bootstrap
    self.run()
  ...
  File "/home/yaz/Voice-toon/api/src/routes/user.py", line 2, in <module>
    ...
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
ModuleNotFoundError: No module named 'services.audio'
^CINFO:     Stopping reloader process [2865422]
(newnev) yaz@gpu:~/Voice-toon/api/src$ cd /Voice-toon
bash: cd: /Voice-toon: No such file or directory
(newnev) yaz@gpu:~/Voice-toon/api/src$ cd ..
(newnev) yaz@gpu:~/Voice-toon/api$ cd ..
(newnev) yaz@gpu:~/Voice-toon$ uvicorn api.src.main:app --reload --port 8000
INFO:     Will watch for changes in these directories: ['/home/yaz/Voice-toon']
INFO:     Uvicorn running on http://127.0.0.1:8000 (Press CTRL+C to quit)
INFO:     Started reloader process [2869346] using StatReload
Process SpawnProcess-1:
Traceback (most recent call last):
  File "/opt/anaconda3/lib/python3.12/multiprocessing/process.py", line 314, in _bootstrap
    self.run()
